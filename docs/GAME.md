...
Between chances, show the match board, score, clock, commentary and statistics. A committed goal, save or miss triggers a short 320x180 Canvas 2D scene: approach, shot and distinct outcome reaction. The initial audition lasts 4.8 seconds at 1x, scales with 1x/2x/3x playback, and returns to the board. Goal scenes celebrate; saves show the goalkeeper; misses show disappointment. Do not simulate continuous physical movement or invent fouls/cards for artwork. Text fallback and reduced-motion support remain available.
...
Keep fullscreen launch, adaptive layout, F11 window toggle, Play/Pause, 1x/2x/3x and optional continuous half-time. No instant finish or manual minute skip. Substitutions, tactics and card/referee scenes await their mechanics gates. Review this small goal/save/miss audition before expanding artwork. Update these existing reference documents as decisions evolve; distinguish implemented behavior from future concepts.
