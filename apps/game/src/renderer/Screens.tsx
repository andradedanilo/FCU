...
export function SquadScreen({state,bench,tactics,lineup,change,suggest,confirm,busy}:{state:Career;bench:()=>void;tactics:()=>void;lineup:PlayerId[];change:(ids:PlayerId[])=>void;suggest:()=>void;confirm:()=>void;busy:boolean}) {
