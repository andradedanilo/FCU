...
export function Clubhouse({state,news,scouting,advance,finance,report,squad,table,match,busy}:{state:Career;news:(id:PlayerId)=>void;scouting:()=>void;advance:(target:'day'|'event')=>void;finance:()=>void;report:()=>void;squad:()=>void;table:()=>void;match:()=>void;busy:boolean}) {
