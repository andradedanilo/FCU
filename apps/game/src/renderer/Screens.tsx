...
export function Clubhouse({state,finance,report,squad,table,match,busy}:{state:Career;finance:()=>void;report:()=>void;squad:()=>void;table:()=>void;match:()=>void;busy:boolean}) {
