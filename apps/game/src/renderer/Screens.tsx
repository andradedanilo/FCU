...
export function SquadScreen({state,training,bench,tactics,lineup,change,suggest,confirm,busy}:{state:Career;training:(value:Career['training'])=>void;bench:()=>void;tactics:()=>void;lineup:PlayerId[];change:(ids:PlayerId[])=>void;suggest:()=>void;confirm:()=>void;busy:boolean}) {
