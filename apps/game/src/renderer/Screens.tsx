...
export function SquadScreen({state,forfeit,callUp,training,bench,tactics,lineup,change,suggest,confirm,busy}:{state:Career;forfeit:()=>void;callUp:()=>void;training:(value:Career['training'])=>void;bench:()=>void;tactics:()=>void;lineup:PlayerId[];change:(ids:PlayerId[])=>void;suggest:()=>void;confirm:()=>void;busy:boolean}) {
