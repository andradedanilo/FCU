...
export function Clubhouse({state,scouting,advance,finance,report,squad,table,match,busy}:{state:Career;scouting:()=>void;advance:(target:'day'|'event')=>void;finance:()=>void;report:()=>void;squad:()=>void;table:()=>void;match:()=>void;busy:boolean}) {
