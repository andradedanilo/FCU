import {createPackedCareer} from '../../../../packages/simulation/src/roster.ts';
...
self.onmessage=(event:MessageEvent<unknown>)=>{
  ...
  try {
    ...
    else if(request.type==='NewPackedCareer')result={ok:true,value:createPackedCareer(request.careerId,request.seed,request.clubId,request.pack)};
