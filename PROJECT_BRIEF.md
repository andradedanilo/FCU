...
Current owner match controls: Play/Pause, 1x/2x/3x and optional continuous half-time. No instant finish or manual minute skip. Start fullscreen with F11 window toggle; prioritize readable original pixel sprites and short expressive highlights. See GAME and ARCHITECTURE for current pacing choices.
