...
v0.2 now includes paused substitutions, three formation presets, mentality/tempo/pressing controls and migration from schema-1/2 checkpoints. Manual bench editing, result summary and controller foundation remain pending; do not mark the milestone complete. Keep pressing fatigue costs for v0.3 and record that the current control affects midfield strength only.
