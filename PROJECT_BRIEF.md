...
Documentation edition 1.5 | Research cutoff: 11 September 2026 | Implementation status: v0.4 financial foundation implemented on Windows. Owner authorizes autonomous development through successive roadmap milestones, retaining the accepted layout and recording unverified external checks. Linux remains unverified. See ROADMAP evidence.
