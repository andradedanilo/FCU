...
Keep the current test ceiling and per-task allowance; do not manufacture extra work, duplicate verification or hide new cases. Maintain the v0.8 feature freeze while fixing release risks and completing existing gates. Requested future match rules remain recorded separately from current supported events.
