...
export const careerSchema=availabilityCareerSchema.extend({engineVersion:z.literal('0.3.2'),rulesetVersion:z.literal('exhibition-6'),match:timedMatchSchema.nullable(),fixtures:z.array(fixtureSchema.extend({score:z.tuple([integer.max(100),integer.max(100)]).nullable()})).length(56)});
