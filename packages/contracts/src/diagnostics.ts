...
export const buildInfoSchema=z.strictObject({appVersion:version,sourceCommit:z.string().regex(/^[a-f0-9]{40}$/).nullable(),sourceDirty:z.boolean(),lockHash:hash,rendererHash:hash.nullable(),sourceHash:hash.nullable()});
